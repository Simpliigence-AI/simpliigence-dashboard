...
/* ── Outbound AI calling ──
 *  CallControls — the 📞 button + live status pill on each candidate row.
 *  Opens CallModal which lets the user pick a template and confirm consent.
 *  CallHistoryPanel — transcript + extracted answers for the latest call
 *  (rendered inside the expanded-row detail).
 */
